                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($l['ketua']) ?></td>
                                ...
                                <td style="min-width: 200px;">
                                    ...
                                    <form method="POST" style="display:flex; flex-direction:column; gap:8px;">
                                        ...
                                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:5px;">
                                            <button type="submit" name="approve" class="btn btn-success btn-icon" style="width: 100%; border-radius: 4px;" title="Setujui"><i class="fa-solid fa-check"></i> Terima</button>
                                            <button type="submit" name="reject" class="btn btn-primary btn-icon" style="background-color: #dc3545; width: 100%; border-radius: 4px;" title="Tolak / Revisi" formnovalidate><i class="fa-solid fa-xmark"></i> Tolak</button>
                                        </div>
                                    </form>
                                    <?php else: ?>
