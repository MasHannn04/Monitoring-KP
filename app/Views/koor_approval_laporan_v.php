                    ...
                    <table class="table" style="font-size: 12px; width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th>Ketua<br>Kelompok</th>
                                <th>Status<br>Dosen Pembimbing</th>
                                <th>Dokumen Lengkap</th>
                                <th>Status Kelulusan</th>
                                <th>Aksi<br>(Validasi Akhir)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle; white-space: normal; word-wrap: break-word; min-width: 150px; max-width: 200px;">
                                ...
                                <td style="vertical-align: middle; white-space: nowrap;">
                                    <?php if($l['status_koor'] == 'acc'): ?>
                                        <span class="badge badge-success"><i class="fa-solid fa-check-double"></i> LULUS</span>
                                    <?php else: ?>
                                ...
                                <td style="vertical-align: middle; min-width: 140px;">
                                    ...
                                    <?php else: ?>
                                        <span style="color: var(--success-green); font-weight: 600;"><i class="fa-solid fa-check"></i> Selesai</span>
                                    <?php endif; ?>
                                </td>
                            </tr>
